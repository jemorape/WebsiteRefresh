<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Host = 'mail.thepatronnc.com'; //Modificar
		$mail->Port = 587; //Modificar

		$mail->Username = 'testpatron@expo.thepatronnc.com'; //Modificar
		$mail->Password = 'testpatron123'; //Modificar

		$mail->setFrom('testpatron@expo.thepatronnc.com', 'Test Email'); //Modificar
